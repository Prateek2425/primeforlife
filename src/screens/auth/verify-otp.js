...
const VerifyOTP = ({ route }) => {
    ...
    //     dispatch({
    //         type: actions.confirmSignUp.type,
    //         payload: {
    //             code: otp,
    //             email: username,
            ...
            <View style={styles.container}>
                <KeyboardAvoidContainer>
                    ...
                    <View>
                        <TextInput
                            value={otp}
                            style={[styles.input, styles.topInput, styles.bottomInput]}
                    ...
                    {/* <View styleName="md-gutter h-center">
                        <Button onPress={onResend} styles={[{ ...globalStyles.button }, { backgroundColor: 'red' }]} >
                            <Text styleName="white button-text">Resend OTP</Text>
                        </Button>
                    </View> */}

                    <View styleName="md-gutter h-center">
                        <Button onPress={onVerify} styles={[{ ...globalStyles.button }, { backgroundColor: 'red' }]} >
                            <Text styleName="white button-text">Verify</Text>
                        </Button>
                    </View>
